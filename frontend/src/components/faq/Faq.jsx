...
export default function Faq() {
    ...
    return (
        <Paper className={classes.root}>
            <Grid container elevation={2} spacing={4}>
                <Grid item xs={12}>
                ...
                <Grid item xs={12} lg={6}>
                    ...
                    <Typography gutterBottom variant="h6" color="textSecondary" align={"left"}>
                        Each team start with a budget to buy their team. Teams take turns putting players on the
                        block, a bidding frenzy ensues and when the timer expires, the team with the highest bid wins
                        the player! The process continues until all teams are full.
                    </Typography>
                </Grid>
                <Grid item xs={12} lg={6} >
                    <Typography gutterBottom variant="h6" color="textPrimary" align={"left"}>
                ...
                <Grid item xs={12} lg={6} style={{paddingRight: "50px"}}>
                    <Typography gutterBottom variant="h6" color="textPrimary" align={"left"}>
